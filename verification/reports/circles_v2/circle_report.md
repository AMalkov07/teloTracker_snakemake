# Circle candidates -- snapshot verification/snapshot_v2

## 7302_day3_with_selection
309 gain-like reads; **49 circle candidates** ({'repeated_unit_from_donor': 15, 'homopolymer_run': 32, 'tandem_amplification_own_array': 2}); ends with >= 3 candidate reads: chr2R, chr3R, chr5R, chr6L, chr11R, chr13L, chr14R, chr16R

### Recurrent (end, class, donor, repeat unit) with >= 2 reads
| chr_end | circle_class | donor | unit | n_reads | max_copies | pct_of_end |
|---|---|---|---|---|---|---|
| chr6L | homopolymer_run |  | ID1 | 4 | 5.0 | 0.9 |
| chr14R | homopolymer_run |  | ID1 | 3 | 3.0 | 0.8 |
| chr11R | repeated_unit_from_donor | chr13L | ID2,ID1 | 3 | 2.0 | 0.7 |
| chr2R | repeated_unit_from_donor | chr13L | ID2,ID1 | 3 | 2.0 | 0.8 |
| chr3R | repeated_unit_from_donor | chr13L | ID2,ID1 | 3 | 2.0 | 0.5 |
| chr16R | homopolymer_run |  | ID1 | 3 | 4.0 | 0.7 |
| chr10R | repeated_unit_from_donor | chr13L | ID2,ID1 | 2 | 2.5 | 0.6 |
| chr15R | homopolymer_run |  | ID1 | 2 | 4.0 | 0.6 |
| chr5R | homopolymer_run |  | ID1 | 2 | 5.0 | 0.4 |
| chr7R | homopolymer_run |  | ID1 | 2 | 3.0 | 0.5 |
| chr16L | homopolymer_run |  | ID1 | 2 | 3.0 | 0.7 |
...
301 gain-like reads; **9 circle candidates** ({'homopolymer_run': 9}); ends with >= 3 candidate reads: none
