# Part B recombination verification — snapshot: verification/snapshot_v2
...
**7 of 32 ends FAIL**; total reads 14202; arm-less sources: 9; ambiguous: 83.
...
| chr13R | 432 | 11 | 2.5 | 11 | 2.5 | 0 | 0.0 | 0 | 10 | 0 | 0 | 2 | 3 | 6 | 1 | ambiguous:6,chr15R:2,chr13L:1,chr16:1 | FAIL |
...
Criterion: non-Loss recombination <= 1.0% per end. Y' Loss is reported as the per-end baseline (subclonal copy-number heterogeneity), not as a failure.
**11 of 32 ends FAIL**; total reads 9317; arm-less sources: 9; ambiguous: 48.
...
| 7172_day6_with_selection | chr11L | 133 | 123 | 92.5 | 0.935 | 3.0 | chr11R:123,chr10L:4,chr14R:3,chr4L:2,chr1R:1 | PASS |
| 7172_day9_with_selection | chr11L | 105 | 101 | 96.2 | 0.889 | 6.7 | chr11R:101,chr10L:1,chr14R:1,chr4R:1,chr1R:1 | PASS |
...
Truth set: reads at other ends with a gain-like Y' status carrying an alternating window >= 3. **Strict set (window >= 4, a full period): 39 reads, 92.3% attributed to chr13L (mean confidence of hits 0.51) -> PASS** (criterion >= 80.0%). All windows >= 3: 68 reads, 85.3%.
...
| 7302_day5_with_selection | SRR33298447.170876 | chr13R | ID2,ID1,ID2,ID1,ID1,ID2,ID1 | 4 | chr13L | 0.0013 | subtelomere_switch |
...
| 7302_day5_with_selection | SRR33298447.9362 | chr3R | ID3,ID1,ID2,ID1,ID1,ID2,ID1,ID2 | 4 | chr13L | 0.0051 | subtelomere_switch |
