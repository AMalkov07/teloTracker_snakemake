...
do
    ...
    do
        ...
        RepeatMasker $query.fasta -lib $database.fasta -s -pa 8 --cutoff 1000 -no_is -norna -gff -dir $repeatmasker_y_prime_dir
...
python get_summary_stats_for_y_prime_repeatmasker.py $base_name $anchor_set $strain_number
...
for pairing in "${parings_to_run[@]}"; do
    ...
    RepeatMasker $query.fasta -lib $database.fasta -s -pa 8 --cutoff 500 -no_is -norna -gff -dir $repeatmasker_dir
