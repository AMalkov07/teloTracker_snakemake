...
for base_name in input_base_name:
      ...
      spacer_switchpoint_file = f'old_0_to_1_repeatmasker_files/{base_name}_paired_good_gained_spacer_repeatmasker.tsv'
      
      x_ends_switchpoint_file = f'old_0_to_1_repeatmasker_files/{base_name}_good_gained_y_x_element_ends_paired_repeatmasker.tsv'
      
      y_prime_repeatmasker_file = f'old_0_to_1_repeatmasker_files/{base_name}_combined_repeatmasker.tsv'           
      ...
      print(len(reads_of_0_to_1_switches))
      ...
      reads_of_0_to_1_switches_x_ends = df_paired_x_ends_data['read_id'].unique()
      print(len(reads_of_0_to_1_switches_x_ends))
      
      
      reads_of_0_to_1_y_gain = df_y_prime_data['read_id'].unique()
      ...
      print(len(reads_of_0_to_1_y_gain))
      ...
      for read_id in reads_of_0_to_1_switches:
            ...
            if read_id in reads_of_0_to_1_switches_x_ends:
            ...
            try:
                  ...
                  print(read_id)
                  print(read_id in reads_of_0_to_1_y_gain)
                  print(its_in_donor)
...
wt_num = len(df_wt)
wt_no_switch_in_spacer_num = df_wt['anchor_and_spacer_switch_to_chr_end_pair'].value_counts()['No Switch']
wt_switch_in_spcaer_num = wt_num - wt_no_switch_in_spacer_num
df_wt_no_spacer_switch = df_wt[df_wt['anchor_and_spacer_switch_to_chr_end_pair'] == 'No Switch']
df_wt_no_switch = df_wt_no_spacer_switch[df_wt_no_spacer_switch['has_x_end'] == 'No Results'] # != 'Switch in X element']

print(f'WT Gain 0 to 1 Events: {wt_num}')
print(f'WT Switch in Spacer Number: {wt_switch_in_spcaer_num}, {(wt_switch_in_spcaer_num/wt_num) * 100}')
print(f'WT No Switch in Spacer Number: {wt_no_switch_in_spacer_num}, {(wt_no_switch_in_spacer_num/wt_num) * 100}')

print("\nWt No Spacer Switch")
print(df_wt_no_spacer_switch['has_x_end'].value_counts(normalize=True)*(wt_no_switch_in_spacer_num/wt_num)*100)
print("\nWt No Spacer or X Switch")
print(df_wt_no_switch['has_its_in_donor'].value_counts())
...
mph_num = len(df_mph)
mph_no_switch_in_spacer_num = df_mph['anchor_and_spacer_switch_to_chr_end_pair'].value_counts()['No Switch']
mph_switch_in_spcaer_num = mph_num - mph_no_switch_in_spacer_num
df_mph_no_spacer_switch = df_mph[df_mph['anchor_and_spacer_switch_to_chr_end_pair'] == 'No Switch']
df_mph_no_switch = df_mph_no_spacer_switch[df_mph_no_spacer_switch['has_x_end'] == 'No Results'] # != 'Switch in X element']

print(f'mph Gain 0 to 1 Events: {mph_num}')
print(f'mph Switch in Spacer Number: {mph_switch_in_spcaer_num}, {(mph_switch_in_spcaer_num/mph_num) * 100}')
print(f'mph No Switch in Spacer Number: {mph_no_switch_in_spacer_num}, {(mph_no_switch_in_spacer_num/mph_num) * 100}')

print("\nmph No Spacer Switch")
print(df_mph_no_spacer_switch['has_x_end'].value_counts(normalize=True)*(mph_no_switch_in_spacer_num/mph_num)*100)
print("\nmph No Spacer or X Switch")
print(df_mph_no_switch['has_its_in_donor'].value_counts())
print('')
