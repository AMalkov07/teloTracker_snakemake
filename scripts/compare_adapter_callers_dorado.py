...
dorado_summary_f_name=f'results/{base_name}/{base_name}_sequencing_summary.tsv'
porechop_results_f_name=f'results/{base_name}/{base_name}_porechopped.tsv'
anchor_blast_f_name=f'results/{base_name}/{base_name}_blasted_{anchor_set}.tsv'
best_anchor_telo_f_name=f'results/{base_name}/top_matches_{base_name}_blasted_{anchor_set}.tsv'


# Output Summary
output_stats_f_name=f'results/{base_name}/{base_name}_adapter_trimming_check.stats'
output_table_f_name=f'results/{base_name}/{base_name}_adapter_trimming_check.tsv'
