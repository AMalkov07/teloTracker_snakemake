...
input_anchor_distances_bed_file = f'references/{strain}_anchors_and_distances.bed'


repeatmasker_results_dir = f'results/{base_name}/paired_x_element_ends_repeatmasker_results/'
repeatmasker_results_dir_list = os.listdir(f'{repeatmasker_results_dir}')
...
for repeatmasker_results_file in all_results_files:
    ...
    try:
        ...
        chr_end_of_file = corrected_repeatmasker_results_file.split("_x_element_ends_repeatmasker_results.ssv")[0]
...
df_all_repeatmakser_results.to_csv(f'{base_name}_paired_x_element_ends_repeatmasker.tsv' , sep= '\t')
...
df_good_repeatmakser_results.to_csv(f'{base_name}_good_x_element_ends_paired_repeatmasker.tsv' , sep= '\t')
...
df_good_gained_y_repeatmakser_results.to_csv(f'{base_name}_good_gained_y_x_element_ends_paired_repeatmasker.tsv' , sep= '\t')
