...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Y prime analysis')
    parser.add_argument('base_name', help='Base name for the sample')
    parser.add_argument('anchor_set', help='Anchor set name')
    
    # Input files
    parser.add_argument('--top-anchor-blast', required=True, help='Top anchor BLAST results TSV')
    parser.add_argument('--telomere-repeat-results', required=True, help='Telomere repeat results TSV')
    parser.add_argument('--probe-blast-dir', required=True, help='Directory containing probe BLAST results')
    
    # Output files
    parser.add_argument('--output-tsv', required=True, help='Main output TSV file')
    parser.add_argument('--output-stats', required=True, help='Statistics output file')
    parser.add_argument('--figure-dir', required=True, help='Directory for output figures')
    parser.add_argument('--combined-probe-output', required=True, help='Combined probe matches TSV')
    ...
    # Use the passed paths
    top_anchor_blast_input = args.top_anchor_blast
    telomere_repeat_results_input = args.telomere_repeat_results
    y_prime_blast_dir_probe = args.probe_blast_dir
    output_tsv_f_name = args.combined_probe_output
    new_output_file = args.output_tsv
    output_stats_f_name = args.output_stats

    #global figure_directory
    figure_directory = args.figure_dir
    ...
    #y_prime_blast_dir=f'../results/{base_name}/y_prime_blast'

    #y_prime_blast_dir_y_primes_mega=f'{y_prime_blast_dir}/y_primes_mega'
    #y_prime_blast_dir_probe=f'{y_prime_blast_dir}'
    ...
    #new_output_file=f'../results/{base_name}/{base_name}_post_y_prime_probe.tsv'
    ...
    #output_stats_f_name = f'../results/{base_name}/{base_name}_stats_y_prime.txt'
