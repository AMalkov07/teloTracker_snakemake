...
bed_file_of_features = f"references/{strain}_final_features.bed"

repeatmasker_results_dir = f'results/{base_name}/paired_spacer_repeatmasker_results/'
...
output_filter_file = f'results/outputs/{base_name}_post_y_prime_probe.tsv'
